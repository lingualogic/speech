 ...
 * CloudAmazonOption Schnittstelle
 *
 * API-Version: 1.0
 * Datum:       11.07.2020
 *
...
/** @export
 * CloudAmazonOption Schnittstelle fuer optionale Konfigurationsparameter von CloudAmazon bei der Initialisierung
 */

export interface CloudAmazonOptionInterface {
    /** legt den konkreten Port fest, der geladen werden soll, wird hier CloudAmazonMock angegeben, wird der Mock geladen */
