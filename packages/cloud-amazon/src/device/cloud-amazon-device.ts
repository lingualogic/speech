 ...
 * CloudAmazon Geraeteklasse fuer TTS, ASR und NLU
 *
...
import { CLOUDAMAZON_DEFAULT_LANGUAGE, CLOUDAMAZON_DEFAULT_VOICE, CLOUDAMAZON_DEFAULT_CODEC } from '../cloud-amazon-const';
import { CloudAmazonConfig } from '../cloud-amazon-config';
import { CloudAmazonConnect } from '../net/cloud-amazon-connect';


/**
 * Basisklasse fuer CloudAmazon Anbindung
 */

export class CloudAmazonDevice extends ErrorBase {

    // innere Komponenten

    protected mConfig: CloudAmazonConfig = null;
    protected mConnect: CloudAmazonConnect = null;
    ...
    /**
     * Erzeugt eine Instanz von CloudDevice
     *
     * @param aConfig - Konfigurationsobjekt fuer Nuance-Konfigurationsdaten
     * @param aConnect - Verbindungsobjekt zu Nuance-Server
     */

    constructor( aDeviceName: string, aConfig: CloudAmazonConfig, aConnect: CloudAmazonConnect ) {
        super( aDeviceName || 'CloudAmazonDevice' );
    ...
    protected _onStart(): number {
        // console.log('CloudAmazonDevice._onStart');
    ...
    protected _onStop(): number {
        // console.log('CloudAmazonDevice._onStop:', this.mTransaction, this.onStop );
    ...
    ****/
    ...
    // TODO: wird in Amazon nicht gebraucht
    /****
    protected _createOption( aOverrideOption: any): any {
    ...
    ****/
    ...
    // TODO: wird in Amazon nicht gebraucht
    /****
    protected _sendQueryEndMessage( aTransactionId: number ): number {
    ...
    ****/
    ...
    start( aTransaction: PortTransaction, aOption?: any ): number {
        // console.log('CloudAmazonDevice.start:', aTransaction, aOption);
        if ( !aTransaction ) {
    ...
    stop( aTransaction: PortTransaction ): number {
        // console.log('CloudAmazonDevice.stop:', aTransaction);
        if ( !aTransaction ) {
