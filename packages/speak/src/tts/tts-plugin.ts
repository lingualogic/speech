...
export class TTSPlugin extends Plugin implements ITTS {
    ...
    protected mSpeakRunningFlag = false;
    ...
    protected mSpeakLanguage = TTS_DEFAULT_LANGUAGE;
    ...
    protected mOnSpeakStartFunc: OnTTSSpeakStartFunc = null;
    ...
    protected mOnSpeakStopFunc: OnTTSSpeakStopFunc = null;
    ...
    protected _onSpeakStart(): number {
        ...
        if ( typeof this.mOnSpeakStartFunc === 'function' ) {
            try {
                ...
                this.exception( '_onSpeakStart', aException );
                return -1;
            }
        }
        return 0;
    ...
    protected _onSpeakStop(): number {
        ...
        if ( typeof this.mOnSpeakStopFunc === 'function' ) {
            try {
                ...
                this.exception( '_onSpeakStop', aException );
                return -1;
            }
        }
        return 0;
    ...
    protected _onSynthesisStart(): number {
    ...
    protected _onSynthesisEnd(): number {
    ...
    protected _onSynthesisError( aEvent: any ): number {
        ...
        try {
            ...
            this.exception( '_onSynthesisError', aException );
            return -1;
        }
    }
    ...
    protected _getTTSLanguage(): string {
    ...
    startSpeak( aText: string ): number {
        ...
        if ( this.isSpeakRunning()) {
            ...
            this.error( 'startSpeak', 'Sprachausgabe laeuft bereits' );
            return -1;
        }
        ...
        if ( !aText ) {
            ...
            // this.error( 'startSpeak', 'kein text uebergeben' );
        ...
        try {
            ...
            this.exception( 'startSpeak', aException );
            this.mSpeakRunningFlag = false;
            return -1;
        }
    }
    ...
    stopSpeak(): number {
        ...
        try {
            ...
            this.exception( 'stopSpeak', aException );
            result = -1;
        }
