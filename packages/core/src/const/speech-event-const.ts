...
export const SPEECH_AGENTSTART_EVENT = 'agentStart';
export const SPEECH_AGENTSTOP_EVENT = 'agentStop';
export const SPEECH_AGENTRESULT_EVENT = 'agentResult';

// Prompt

export const SPEECH_PROMPTSTART_EVENT = 'promptStart';
export const SPEECH_PROMPTSTOP_EVENT = 'promptStop';
export const SPEECH_PROMPTRESULT_EVENT = 'promptResult';
