...
export class Plugin extends ErrorBase implements PluginInterface {
    ...
    protected mOnInitFunc: OnSpeechInitFunc = null;
    protected mOnErrorFunc: OnSpeechErrorFunc = null;

    // interne Attribute

    private mInitFlag = false;
    private mActiveFlag = false;
    ...
    protected _onInit(): number {
        ...
        if (typeof this.mOnInitFunc === 'function') {
            try {
                ...
                this.exception( 'Plugin._onInit', aException );
                return -1;
            }
        }
        return 0;
