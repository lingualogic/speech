...
export class ActionFunction extends Plugin implements ActionFunctionInterface {
    ...
    private mActionFunctionList = new ActionFunctionList();
    ...
    constructor( aPluginName = '', aRegisterFlag = true ) {
        super( aPluginName || ACTIONFUNCTION_PLUGIN_NAME, aRegisterFlag );
        this._setErrorClassName( 'ActionFunction' );
        this.mActionFunctionList.setErrorOutputFunc( this._getErrorOutputFunc());
    }
    ...
    setErrorOutput( aErrorOutputFlag: boolean ): void {
        ...
        this.mActionFunctionList.setErrorOutput( aErrorOutputFlag );
    }
