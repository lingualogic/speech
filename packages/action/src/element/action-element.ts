...
export class ActionElement extends Plugin implements ActionElementInterface {
    ...
    private mActionElementList = new ActionElementList();
    ...
    constructor( aPluginName = '', aRegisterFlag = true ) {
        super( aPluginName || ACTIONELEMENT_PLUGIN_NAME, aRegisterFlag );
        this._setErrorClassName( 'ActionElement' );
        this.mActionElementList.setErrorOutputFunc( this._getErrorOutputFunc());
    }
    ...
    setErrorOutput( aErrorOutputFlag: boolean ): void {
        ...
        this.mActionElementList.setErrorOutput( aErrorOutputFlag );
    }
