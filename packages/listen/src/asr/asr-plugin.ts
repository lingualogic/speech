...
export class ASRPlugin extends Plugin implements IASR {
    ...
    protected mListenRunningFlag = false;
    ...
    protected mListenLanguage = ASR_DEFAULT_LANGUAGE;
    ...
    protected mListenMode = ASR_DEFAULT_MODE;
    ...
    protected mListenTimeoutTime = ASR_TIMEOUT_TIME;
    ...
    protected mListenResultFlag = false;
    ...
    protected mOnListenStartFunc: OnASRListenStartFunc = null;
    ...
    protected mOnListenStopFunc: OnASRListenStopFunc = null;
    ...
    protected mOnListenResultFunc: OnASRListenResultFunc = null;
    ...
    protected mOnListenInterimResultFunc: OnASRListenResultFunc = null;
    ...
    protected mOnListenNoMatchFunc: OnASRListenNoMatchFunc = null;
    ...
    protected mOnListenRecognitionStartFunc: OnASRListenStartFunc = null;
    ...
    protected mOnListenRecognitionStopFunc: OnASRListenStopFunc = null;
    ...
    protected mOnListenAudioStartFunc: OnASRListenStartFunc = null;
    ...
    protected mOnListenAudioStopFunc: OnASRListenStopFunc = null;
    ...
    protected mOnListenSoundStartFunc: OnASRListenStartFunc = null;
    ...
    protected mOnListenSoundStopFunc: OnASRListenStopFunc = null;
    ...
    protected mOnListenSpeechStartFunc: OnASRListenStartFunc = null;
    ...
    protected _onListenStart(): number {
        ...
        try {
            ...
            this.exception( '_onListenStart', aException );
            return -1;
        }
    }
    ...
    protected _onListenStop(): number {
        ...
        try {
            ...
            this.exception( '_onListenStop', aException );
            return -1;
        }
    }
    ...
    protected _onListenResult( aResultData: any ): number {
        ...
        try {
            ...
            this.exception( '_onListenResult', aException );
            return -1;
        }
    }
    ...
    protected _onListenInterimResult( aResultData: any ): number {
        ...
        try {
            ...
            this.exception( '_onListenInterimResult', aException );
            return -1;
        }
    }
    ...
    protected _onListenNoMatch(): number {
        ...
        try {
            ...
            this.exception( '_onListenNoMatch', aException );
            return -1;
        }
    }
    ...
    protected _onListenRecognitionStart(): number {
        ...
        try {
            ...
            this.exception( '_onListenRecognitionStart', aException );
            return -1;
        }
    }
    ...
    protected _onListenRecognitionStop(): number {
        ...
        try {
            ...
            this.exception( '_onListenRecognitionStop', aException );
            return -1;
        }
    }
    ...
    protected _onListenAudioStart(): number {
        ...
        try {
            ...
            this.exception( '_onListenAudioStart', aException );
            return -1;
        }
    }
    ...
    protected _onListenAudioStop(): number {
        ...
        try {
            ...
            this.exception( '_onListenAudioStop', aException );
            return -1;
        }
    }
    ...
    protected _onListenSoundStart(): number {
        ...
        try {
            ...
            this.exception( '_onListenSoundStart', aException );
            return -1;
        }
    }
    ...
    protected _onListenSoundStop(): number {
        ...
        try {
            ...
            this.exception( '_onListenSoundStop', aException );
            return -1;
        }
    }
    ...
    protected _onListenSpeechStart(): number {
        ...
        try {
            ...
            this.exception( '_onListenSpeechStart', aException );
            return -1;
        }
    }
    ...
    protected _onListenSpeechStop(): number {
        ...
        try {
            ...
            this.exception( '_onListenSpeechStop', aException );
            return -1;
        }
    }
    ...
    protected _setRecognitionTimeout(): void {
        this._clearRecognitionTimeout();
    ...
    protected _clearRecognitionTimeout(): void {
    ...
    protected _onRecognitionStart(): number {
    ...
    protected _onRecognitionEnd(): number {
    ...
    protected _onRecognitionAudioStart(): number {
    ...
    protected _onRecognitionAudioEnd(): number {
    ...
    protected _onRecognitionSoundStart(): number {
    ...
    protected _onRecognitionSoundEnd(): number {
    ...
    protected _onRecognitionSpeechStart(): number {
    ...
    protected _onRecognitionSpeechEnd(): number {
        // console.log('ASRPlugin._onRecognitionSpeechEnd');
        const result = this._onListenSpeechStop();
    ...
    protected _onRecognitionResult( aEvent: any ): number {
        ...
        try {
            ...
            this.exception( '_onRecognitionResult', aException );
            result = -1;
        }
        // pruefen auf Command Mode
        if ( this.isCommandMode()) {
    ...
    protected _onRecognitionNoMatch( aEvent: any ): number {
    ...
    protected _onRecognitionError( aEvent: any ): number {
        ...
        try {
            ...
            this.exception( '_onRecognitionError', aException );
            return -1;
        }
    }
    ...
    protected _getASRLanguage(): string {
    ...
    setMode( aMode: string ): number {
        ...
        this.error( 'setMode', 'kein gueltiger Eingabemodus uebergeben' );
        return -1;
    }
    ...
    stopListen(): number {
        ...
        try {
            ...
            this.exception( 'stopListen', aException );
            result = -1;
        }
    ...
    abortListen(): number {
        ...
        if ( !this.isListenRunning()) {
            // TODO: Sollte eigentlich kein Fehler sein, da StopListen immer aufrufbar sein soll,
            //       auch wenn gerade keine Sprachausgabe laeuft
            // this.error( 'abortListen', 'Spracheingabe nicht gestartet' );
            return 0;
        }
        ...
        try {
            ...
            this.exception( 'abortListen', aException );
            result = -1;
        }
