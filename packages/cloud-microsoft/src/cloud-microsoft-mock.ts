 ...
 * CloudMicrosoftMock zum Testen des CloudMicrosoft Cloud-Service mit dem Framework
 *
...
const MICROSOFTMOCK_CALLBACK_TIMEOUT = 100;


/**
 * Definiert die CloudMicrosoftMock-Klasse
 */

export class CloudMicrosoftMock extends Port {

    audioContextFlag = true;
    getUserMediaFlag = true;

    microsoftNLUFlag = true;
    microsoftASRFlag = true;
    microsoftTTSFlag = true;
    ...
    constructor( aPortName?: string, aRegisterFlag = true ) {
        super( aPortName || CLOUDMICROSOFT_MOCK_NAME, aRegisterFlag );
    }
    ...
    init( aOption?: any ): number {
        // console.log('CloudMicrosoftMock: init start', aOption);
        ...
        if ( this.isErrorOutput()) {
            if ( this.microsoftNLUFlag ) {
                console.log('CloudMicrosoftMock: NLU ist vorhanden');
            } else {
                console.log('CloudMicrosoftMock: NLU ist nicht vorhanden');
            }
            if ( this.microsoftTTSFlag ) {
                console.log('CloudMicrosoftMock: TTS ist vorhanden');
            } else {
                console.log('CloudMicrosoftMock: TTS ist nicht vorhanden');
            }
            if ( this.microsoftASRFlag ) {
                console.log('CloudMicrosoftMock: ASR ist vorhanden');
            } else {
                console.log('CloudMicrosoftMock: ASR ist nicht vorhanden');
            }
        }
        this._onInit( 0 );
        // console.log('CloudMicrosoftMock.init: ende');
     ...
     *
     * @param {CloudMicrosoftConfigDataInterface} aConfigData - Konfigurationsdaten { microsoftRegion: '', microsoftSubscriptionKey: ''}
     *
    ...
    _startTTS( aTransaction: PortTransaction, aText: string, aLanguage: string, aVoice: string ): number {
        ...
        try {
            ...
            setTimeout( () => this._onStop( aTransaction.plugin, aTransaction.type ), MICROSOFTMOCK_CALLBACK_TIMEOUT );
            return 0;
        } catch ( aException ) {
