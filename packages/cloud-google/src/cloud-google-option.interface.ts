 ...
 * CloudGoogleOption Schnittstelle
 *
 * API-Version: 1.0
 * Datum:       11.07.2020
 *
...
/** @export
 * CloudGoogleOption Schnittstelle fuer optionale Konfigurationsparameter von CloudGoogle bei der Initialisierung
 */

export interface CloudGoogleOptionInterface {
