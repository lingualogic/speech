...
export class DialogBase extends BaseComponent implements DialogComponentInterface {
    ...
    protected _onDialogAction( aAction: DialogActionInterface ): number {
    ...
    protected _onDialogSpeak( aSpeak: DialogSpeakInterface ): number {
    ...
    protected _getContext(): DialogStateContextInterface {
