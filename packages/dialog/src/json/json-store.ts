...
export class JsonStore extends ErrorBase {
    ...
    private mDialogList: DialogDataInterface[] = null;
    private mDialog: DialogDataInterface = null;
    private mDialogName = '';

    private mStateList: DialogStateInterface[] = null;
    private mState: DialogStateInterface = null;
    private mStateName = '';

    private mIntentList: DialogIntentInterface[] = null;
    private mIntent: DialogIntentInterface = null;
    private mIntentName = '';

    private mCommandList: DialogCommandInterface[] = null;

    private mTextList: DialogTextInterface[] = null;
    private mText: DialogTextInterface = null;
    private mTextName = '';
