...
export class JsonFactory extends PluginFactory {
    ...
    protected _newPlugin( aPluginName: string, aPluginClass: string, aRegisterFlag: boolean ): IJson {
    ...
    create( aPluginName?: string, aPluginClass = '', aRegisterFlag = true ): IJson {
