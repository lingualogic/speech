...
import { DialogServiceInterface } from './dialog-service.interface';
...
export type DialogServiceActionStartFunc = (aAction: DialogActionInterface) => void;
...
export class DialogService extends Service implements DialogServiceInterface {
    ...
    private mDialogActionEvent = new EventEmitter<DialogActionInterface>( DIALOG_ASYNC_EVENT );
    private mDialogActionStopEvent = new EventEmitter<any>( DIALOG_ASYNC_EVENT );
    private mDialogSpeakEvent = new EventEmitter<DialogSpeakInterface>( DIALOG_ASYNC_EVENT );
    ...
    static getConfig(): DialogOptionInterface {
    ...
    protected _setOption( aOption: DialogOptionInterface ): number {
    ...
    reset( aOption?: DialogOptionInterface ): number {
