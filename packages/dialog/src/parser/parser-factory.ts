...
export class ParserFactory extends PluginFactory {
    ...
    protected _newPlugin( aPluginName: string, aPluginClass: string, aRegisterFlag: boolean ): IParser {
    ...
    create( aPluginName?: string, aPluginClass = '', aRegisterFlag = true ): IParser {
