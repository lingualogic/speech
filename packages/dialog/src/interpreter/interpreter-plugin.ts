...
import { SPEECH_DIALOGACTION_EVENT, SPEECH_DIALOGSPEAK_EVENT, Plugin } from '@speech/core';
...
export class InterpreterPlugin extends Plugin implements InterpreterInterface {
    ...
    private mStateContext: DialogStateContextInterface = null;
    ...
    protected _onDialogAction( aNode: DialogNodeInterface ): number {
    ...
    protected _onDialogSpeak( aNode: DialogNodeInterface ): number {
    ...
    protected _getDialogState( aDialogName: string, aStateName: string ): DialogStateInterface {
    ...
    protected _getWaitNode(): DialogNodeInterface {
    ...
    protected async _runState( aDialogState: DialogStateInterface ) {
    ...
    protected _runAsyncNode( aNode: DialogNodeInterface, aTimeout: number ): Promise<any> {
    ...
    protected _runNode( aNode: DialogNodeInterface ): void {
    ...
    protected _runGroup( aNode: DialogNodeInterface ): void {
    ...
    protected _checkRunNode( aNode: DialogNodeInterface ): boolean {
    ...
    protected _runAction( aNode: DialogNodeInterface ): void {
    ...
    protected _runSpeak( aNode: DialogNodeInterface ): void {
    ...
    protected _runWait( aNode: DialogNodeInterface ): void {
