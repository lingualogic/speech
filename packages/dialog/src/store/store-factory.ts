...
export class StoreFactory extends PluginFactory {
    ...
    protected _newPlugin( aPluginName: string, aPluginClass: string, aRegisterFlag: boolean ): StoreInterface {
    ...
    create( aPluginName?: string, aPluginClass = '', aRegisterFlag = true ): StoreInterface {
