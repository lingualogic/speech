...
import { OnSpeechErrorFunc } from '@lingualogic-speech/core';
...
import { IDialogComponent } from './component/dialog-component.interface';
...
export class Dialog extends Base implements IDialog {


    // interne Dialog-Komponente

    private mDialogComponent: IDialogComponent;
    ...
    constructor( aOption?: IDialogOption ) {
        super( aOption );
        this.mDialogComponent = this.mComponent as IDialogComponent;
    }
    ...
    isExistDialogState( aState: string ): boolean {
        return this.mDialogComponent.isExistDialogState( aState );
    }
    ...
    isExistState( aState: string ): boolean {
        return this.isExistDialogState( aState );
    }
