...
export class NLUPlugin extends Plugin implements NLUInterface {
     ...
     * @private
     */
    protected mListenLanguage = NLU_DEFAULT_LANGUAGE;
    ...
    protected mListenTimeoutTime = NLU_TIMEOUT_TIME;
    ...
    protected mOnConnectFunc: OnNLUConnectFunc = null;
    ...
    protected mOnDisconnectFunc: OnNLUDisconnectFunc = null;
    ...
    protected mOnListenStartFunc: OnNLUListenStartFunc = null;
    ...
    protected mOnListenStopFunc: OnNLUListenStopFunc = null;
    ...
    protected mOnListenResultFunc: OnNLUListenResultFunc = null;
    ...
    protected mOnIntentResultFunc: OnNLUIntentResultFunc = null;
    ...
    protected _onConnect(): number {
        ...
        try {
            ...
            this.exception( '_onConnect', aException );
            return -1;
        }
    }
    ...
    protected _onDisconnect(): number {
        ...
        try {
            ...
            this.exception( '_onDisconnect', aException );
            return -1;
        }
    }
    ...
    protected _onIntentResult( aIntentData: any ): number {
        ...
        try {
            ...
            this.exception( '_onIntentResult', aException );
            return -1;
        }
    }
    ...
    protected _onRecognitionOpen(): number {
    ...
    protected _onRecognitionClose(): number {
    ...
    protected _getRecognitionResult( aResult: any ): any {
    ...
    protected _getRecognitionIntentResult( aResult: any ): any {
        // hier wird das Ergebnis in ein definiertes Result-DatentransferObjekt umgewandelt
        // muss von erbenden Klassen ueberschrieben werden
        return aResult;
    }
    ...
    protected _onRecognitionIntentResult( aEvent: any ): number {
    ...
    protected _getNLULanguage(): string {
    ...
    protected _startRecognitionIntent( aText: string ): number {
        this.error( '_startRecognitionIntent', 'Keine NLU vorhanden' );
        return -1;
    }
    ...
    startIntent( aText: string ): number {
        ...
        if ( !aText ) {
            this.error( 'startIntent', 'kein Text uebergeben' );
            return -1;
        }

        if ( this.isListenRunning()) {
            this.error( 'startIntent', 'Sprachanalyse laeuft bereits' );
            return -1;
        }
        ...
        try {
            ...
            this.exception( 'startIntent', aException );
            return -1;
        }
    ...
    startListen(): number {
        ...
        if ( !this.isListen()) {
            this.error( 'startIntent', 'keine ASRNLU vorhanden' );
            return -1;
        }
