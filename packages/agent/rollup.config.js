// rollup.config.js fuer SpeechAssistant/Agent
...
console.log('');
console.log('********************************************************************');
console.log('**  Speech-Assistant VERSION: ' + SPEECH_VERSION_STRING + '  **');
console.log('**                                                                **');
console.log('**                 Agent Bundle wird erzeugt                      **');
console.log('********************************************************************');
console.log('');


// Parameter fuer die Erzeugung der SpeechAgent.js Datei
...
export default {
    ...
    output: {
        ...
        globals: {
            ...
            "@speech/intent": "speechIntent",
            "@speech/listen": "speechListen",
            "@speech/speak": "speechSpeak",
            "@speech/cloud-google": "speechCloudGoogle",
            "@speech/cloud-rasa": "speechCloudRasa"
        }
    },
