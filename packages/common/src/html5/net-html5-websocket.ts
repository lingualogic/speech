...
export class NetHtml5WebSocket extends ErrorBase {
    ...
    private mWebSocketUrl = '';
    private mWebSocket: WebSocket = null;
    private mWebSocketOpenFlag = false;


    // Verbindungswiederholungen

    private mConnectInfiniteFlag = false;
    private mConnectIntervalId: any = 0;
    private mConnectIntervalTimeout = NET_CONNECTINTERVAL_TIMEOUT;


    // Ereignisse

    private mOnOpenFunc: OnNetHtml5OpenFunc = null;
    private mOnCloseFunc: OnNetHtml5CloseFunc = null;
    private mOnMessageFunc: OnNetHtml5MessageFunc = null;
    private mOnErrorFunc: OnNetHtml5ErrorFunc = null;
    ...
    protected _detectWebSocket(): boolean {
